...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ko: {
    ...
    modules_workflow_title: "워크플로우 라이브러리",
    modules_workflow_subtitle: "실제 사용 사례별 모듈 조합 예시",
    modules_workflow_email: "📧 이메일 자동 분류",
    modules_workflow_email_desc: "Bot + ShieldCheck + FileSearch 조합으로 받은 메일함을 자동 분류하고 중요 메일만 알림",
    modules_workflow_email_modules: "Bot, ShieldCheck, FileSearch",
    modules_workflow_doc: "📄 문서 요약 리포트",
    modules_workflow_doc_desc: "FileSearch + FileEdit + Bot으로 여러 문서를 검색하여 요약 리포트 자동 생성",
    modules_workflow_doc_modules: "FileSearch, FileEdit, Bot",
    modules_workflow_youtube: "🎥 유튜브 학습",
    modules_workflow_youtube_desc: "YouTube + Bot + FileEdit로 강의 영상 자막을 추출하고 요약 노트 생성",
    modules_workflow_youtube_modules: "YouTube, Bot, FileEdit",
    modules_workflow_security: "🔒 보안 감사",
    modules_workflow_security_desc: "ShieldCheck + Activity + Monitor로 위험한 작업 자동 감지 및 승인 흐름 관리",
    modules_workflow_security_modules: "ShieldCheck, Activity, Monitor",
    modules_workflow_team: "👥 팀 협업",
    modules_workflow_team_desc: "Users + Activity + Bot으로 팀원별 작업 권한 관리 및 작업 이력 추적",
    modules_workflow_team_modules: "Users, Activity, Bot",
    modules_workflow_monitoring: "📊 시스템 모니터링",
    modules_workflow_monitoring_desc: "Monitor + Activity + Bot으로 시스템 상태 실시간 추적 및 이상 감지 시 알림",
    modules_workflow_monitoring_modules: "Monitor, Activity, Bot",
    
    // Comparison Table
    modules_comparison_title: "경쟁사 비교",
    modules_comparison_subtitle: "NEXUS-ON vs 다른 AI 어시스턴트",
    modules_comparison_feature: "기능",
    modules_comparison_nexus: "NEXUS-ON",
    modules_comparison_copilot: "GitHub Copilot",
    modules_comparison_chatgpt: "ChatGPT Plus",
    modules_comparison_claude: "Claude Pro",
    modules_comparison_live2d: "Live2D 캐릭터",
    modules_comparison_korean: "한글 문서 (HWP)",
    modules_comparison_local: "Local-first",
    modules_comparison_hitl: "Human-in-the-Loop",
    modules_comparison_modules: "전문 모듈 (8개)",
    modules_comparison_monitoring: "실시간 모니터링",
    modules_comparison_yes: "✅",
    modules_comparison_no: "❌",
    modules_comparison_partial: "⚠️",
    ...
    // Download Page (Korean)
    download_page_title: '다운로드',
    download_page_subtitle: '세리아 AI 캐릭터 비서의 백엔드 엔진',
    download_setup_desc: 'GUI 설치 프로그램 (권장)',
    download_setup_feature_1: '클릭만으로 자동 설치',
    download_setup_feature_2: 'Windows 서비스 자동 등록',
    download_setup_feature_3: '방화벽 규칙 자동 추가',
    download_setup_feature_4: '약 50MB, 5분 소요',
    download_setup_note: '빌드 중 - 곧 제공 예정',
    download_powershell_desc: '자동 설치 스크립트',
    download_powershell_feature_1: 'Python 자동 설치',
    download_powershell_feature_2: '의존성 자동 설치',
    download_powershell_feature_3: '서비스 자동 등록',
    download_powershell_feature_4: '개발자에게 권장',
    download_button: '다운로드',
    download_copy_script: '스크립트 복사',
    download_copy_success: '스크립트가 클립보드에 복사되었습니다!\\n\\nPowerShell(관리자)에서 붙여넣기(Ctrl+V)하세요.',
    download_requirements: '시스템 요구사항',
    download_req_os: '운영체제',
    download_req_memory: '메모리',
    download_req_memory_value: '최소 4GB RAM (권장 8GB)',
    download_req_storage: '저장 공간',
    download_req_storage_value: '최소 5GB 여유 공간',
    download_quick_start: '빠른 시작',
    download_step_1: '위 방법 중 하나로 설치',
    download_step_2: 'API 키 설정 (.env 파일 수정)',
    download_step_3: '브라우저에서',
    download_step_4: '프론트엔드와 연결',
    download_guide: '설치 가이드',
    download_build: '빌드 방법',
  },
  en: {
    nav_home: "Home",
    nav_intro: "About",
    ...
    download_page_subtitle: 'Backend engine for Ceria AI Character Assistant',
    download_setup_desc: 'GUI Installer (Recommended)',
    download_setup_feature_1: 'Automated installation',
    download_setup_feature_2: 'Windows service auto-registration',
    download_setup_feature_3: 'Firewall rules auto-configuration',
    download_setup_feature_4: 'About 50MB, 5 minutes',
    download_setup_note: 'Under construction - Coming soon',
    download_powershell_desc: 'Automated installation script',
    download_powershell_feature_1: 'Python auto-install',
    download_powershell_feature_2: 'Dependencies auto-install',
    download_powershell_feature_3: 'Service auto-registration',
    download_powershell_feature_4: 'Recommended for developers',
    download_button: 'Download',
    download_copy_script: 'Copy Script',
    download_copy_success: 'Script copied to clipboard!\\n\\nPaste it in PowerShell (Admin) with Ctrl+V.',
    download_requirements: 'System Requirements',
    download_req_os: 'Operating System',
    download_req_memory: 'Memory',
    download_req_memory_value: 'Minimum 4GB RAM (8GB recommended)',
    download_req_storage: 'Storage',
    download_req_storage_value: 'Minimum 5GB free space',
    download_quick_start: 'Quick Start',
    download_step_1: 'Install using one of the methods above',
    download_step_2: 'Configure API keys (.env file)',
    download_step_3: 'Open in browser',
    download_step_4: 'Connect to frontend',
    download_build: 'Build Instructions',
    ...
    intro_philosophy_title: "제품 철학",
    intro_philosophy_subtitle: "NEXUS-ON이 추구하는 핵심 가치",
    intro_philosophy_hitl: "Human-in-the-Loop",
    intro_philosophy_hitl_desc: "AI가 자율적으로 작동하지만, 중요한 결정은 항상 사용자가 승인합니다. RED 위험도 작업(파일 삭제, 외부 공유)은 Two-phase commit으로 안전하게 보호됩니다.",
    intro_philosophy_approvals: "승인 시스템",
    intro_philosophy_approvals_desc: "모든 작업은 GREEN/YELLOW/RED 3단계 위험도로 분류됩니다. 위험한 작업일수록 사용자의 명시적 승인이 필요하며, 대시보드에서 실시간으로 승인 대기 목록을 확인할 수 있습니다.",
    intro_philosophy_cost: "비용 절감",
    intro_philosophy_cost_desc: "Windows 11 로컬 엔진으로 서버 비용 없이 운영 가능합니다. 오픈소스 LLM(GLM-4.7, Kimi K2.5) 지원으로 API 비용을 최소화하고, 토큰 사용량을 실시간으로 모니터링합니다.",
    
    // Ceria System Section
    intro_ceria_title: "세리아 시스템",
    intro_ceria_subtitle: "Live2D 캐릭터 비서의 5가지 상태",
    intro_ceria_idle: "Idle (대기)",
    intro_ceria_idle_desc: "사용자 입력을 기다리는 평온한 상태",
    intro_ceria_listening: "Listening (듣기)",
    intro_ceria_listening_desc: "사용자의 음성 입력을 받고 있는 상태",
    intro_ceria_thinking: "Thinking (생각)",
    intro_ceria_thinking_desc: "LLM이 응답을 생성하는 중",
    intro_ceria_speaking: "Speaking (말하기)",
    intro_ceria_speaking_desc: "TTS로 응답을 전달하는 상태 (립싱크 포함)",
    intro_ceria_busy: "Busy (작업 중)",
    intro_ceria_busy_desc: "백그라운드에서 파일 검색, 문서 작성 등 작업 수행 중",
