...
| Issue | AUTOFIX_ISSUE_HISTORY_IN_BODY | true | Keep history inside issue body markers |
| Issue | AUTOFIX_ISSUE_HISTORY_MAX | 10 | Max history entries in issue body |
| Webhook | AUTOFIX_ALERT_WEBHOOK_FORMAT | text | text/slack_blocks/teams_adaptive |
